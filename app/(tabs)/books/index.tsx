            ...
            <FlatList numColumns={2} style={{flex: 1, width: 400, padding: 8, backgroundColor:'#7dd3fc'}}
                ...
                renderItem={({item}) => (
                    ...
                    <Pressable style={{padding: 4}} onPress={() => {
                        ...
                        <Image 
                            source={{uri: item.volumeInfo.imageLinks?.thumbnail.replace('http://', 'https://')}} alt='Book image'
